...
namespace ce.gewichten
{
    public static class GraphGenerator
    {
        ...
        /// </summary>
        public static void Sortieren(Graph graph, Action<ce.contracts.Gewichtung> ok, Action fehler)
        {
        ...
        internal static void TopologischSortieren(Graph graph, Dictionary<int, int> vorgaenger, Action<ce.contracts.Gewichtung> ok, Action fehler)
        {
            ...
            ok(new ce.contracts.Gewichtung { StoryIndizes = storyIndizes });
        }
    }
}